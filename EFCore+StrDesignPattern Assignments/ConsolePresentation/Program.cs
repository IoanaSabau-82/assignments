...
namespace ConsolePresentation
{
    internal class Program
    {
        ...
        {
            //proxy
            var repoProxy = new UserRepositoryProxy();
            var user1 = new User
            {
                FirstName = "Cristian",
                LastName = "Pop",
            ...
            var assignment1 = new AssignedVolunteer
            {
                ...
                PostId = Guid.Parse("81B5108A-B77B-431B-A226-08DA236D9FBC"),
                CreatedOn = DateTime.Now,
                ScheduledTime = DateTime.Now.AddDays(1),
            };


            var facade = new AssignedVolunteerFacade();
            facade.GetAssignedToPost(assignment1);

            //decorator

            IUser userActivities = new UserForPattern();
            Console.WriteLine(userActivities.Activities());

            userActivities = new AddChat(userActivities);
            userActivities = new AddSpotify(userActivities);
            Console.WriteLine(userActivities.Activities());
